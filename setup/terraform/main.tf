...
# Github Action role
####################
resource "aws_iam_user" "github_action_myuser2" {
  name = "github_action_myuser2"
}

resource "aws_iam_user_policy" "github_action_myuser2_permission" {
  user   = aws_iam_user.github_action_myuser2.name
