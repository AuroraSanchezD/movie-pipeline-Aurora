...
# Github Action role
####################
resource "aws_iam_user" "github_action_myuser1" {
  name = "github_action_myuser1"
}

resource "aws_iam_user_policy" "github_action_myuser1_permission" {
  user   = aws_iam_user.github_action_myuser1.name
