...
# Github Action role
####################
resource "aws_iam_user" "github-action-myuser" {
  name = "github-action-myuser"
}

resource "aws_iam_user_policy" "github-action-myuser_permission" {
  user   = aws_iam_user.github-action-myuser.name
